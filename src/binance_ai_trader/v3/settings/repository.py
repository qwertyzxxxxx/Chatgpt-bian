...
LIVE_DEFAULTS: dict[str, dict[str, object]] = {
    ...
    V66_STRATEGY_ID:  {"live_enabled": False, "notional_usdt": "1000"},
    V663_STRATEGY_ID: {"live_enabled": False, "notional_usdt": "1000"},
    "classic_k3":     {"live_enabled": True,  "notional_usdt": "1000"},
