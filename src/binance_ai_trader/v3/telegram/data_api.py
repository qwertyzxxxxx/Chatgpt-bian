...
def _candidate_to_dict(c) -> dict:
    return {
        ...
        "score_total":           getattr(c, "score_total",           None),
        "score_grade":           getattr(c, "score_grade",           None),
        "score_version":         getattr(c, "score_version",         None),
        "volume_score":          getattr(c, "volume_score",          None),
        "trend_structure_score": getattr(c, "trend_structure_score", None),
        "entry_position_score":  getattr(c, "entry_position_score",  None),
        "risk_reward_score":     getattr(c, "risk_reward_score",     None),
        "strategy_fit_score":    getattr(c, "strategy_fit_score",    None),
        "score_summary":         getattr(c, "score_summary",         None),
        "scored_at":             getattr(c, "scored_at",             None),
    }
