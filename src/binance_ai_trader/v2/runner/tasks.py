...
Startup notification:
  send_v2_startup() is called synchronously from cli.py before the runner
  loop starts (same pattern as V1), NOT via a scheduled task.
...
def build_v2_tasks(
    ...
    if reporter:
        tasks.append(RunnerTask("v2_shadow_report", _shadow_report_task, interval=report_interval, startup_immediate=True))
