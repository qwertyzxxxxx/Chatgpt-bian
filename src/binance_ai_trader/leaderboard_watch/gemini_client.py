...
from .models import WatchDecision
...
def _parse_decision(data: dict[str, Any], raw: str) -> WatchDecision:
    ...
    *,
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            return decision, _prompt_hash(prompt)
    ...
    return WatchDecision.no_trade(raw), _prompt_hash(prompt)
